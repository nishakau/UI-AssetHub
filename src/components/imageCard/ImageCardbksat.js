    ...
    render() {
        ...
        return (
            <Row className="sectionCover mt-30" >
                <h5 id="winContent" class="col-md-12 mt-20 ">All Wins
                {/* ( {WinCnt} ) */}
                </h5>
                ...
                {WinCnt != 0 ? (
                    ...
                    <div id="dataWinShow" class="dataWindow col-md-12">
                        <Tabs defaultActiveKey="Wins" id="uncontrolled-tab-example" className="mb-4">
                            ...
                            <Tab eventKey="Wins" title={winHeader}>
                                <div className="Scroll" >
                                    {onlyWinData.map((winData, index) =>
                                        <Col md={4} data-id={winData.WINSTORY_ID} style={{ border: "thin solid #e0e0e0", borderRadius: "12px", backgroundSize: "cover", backgroundImage: "url(" + winData.WINSTORY_LOGO + ")" }} className="mb-4 itemCardHomePage cards" >
                                            {/* <div class="extta"> */}
                                            ...
                                            <div class="dfd">
                                                ...
                                                <div className="cardInforHomePage">
                                                    ...
                                                    <div className="tooltipCustom">
                                                        ...
                                                        <div style={{ width: "100%" }}>
                                                            <span style={{ color: '#F2A006', fontWeight: 600 }}>Competition : </span>
                            ...
                            <Tab eventKey="PendingRectification" title={consultingwinHeader}>
                                <div className="Scroll" >


                                    {onlyConsultingWin.map((winData, index) =>
                                        <Col md={4} data-id={winData.WINSTORY_ID} style={{ borderRadius: "12px", backgroundSize: "cover", backgroundImage: "url(" + winData.WINSTORY_LOGO + ")" }} className="mb-4 itemCardHomePage cards" onClick={this.handleViewWin(winData.WINSTORY_ID)}>
                                            {/* <div class="extta"> */}
                                            {winData.PROMOTE == true &&
                                                <div class="promoted" >Promoted</div>}
                                            <div class="dfd">
              ...
              <> */}
                <>
                    ...
                    <h5 class="col-md-12 sectionCover" id="assetContent">Assets
                    {/* ( {AsstCnt} ) */}
                    </h5>
                    {AsstCnt != 0 ? (
                        <div id="dataAssetShow" class="col-md-12">
                            ...
                            <div className="Scroll" >
                                {AssetDatanew.map((AssetData, index) =>
                                    <Col md={4} data-id={AssetData.ASSET_ID} style={{ borderRadius: "12px", backgroundSize: "cover", backgroundImage: "url(" + AssetData.ASSET_THUMBNAIL + ")" }} className="mb-4 itemCardHomePage cards" >
                                        {/* <div class="extta"> */}
                 ...
                 <a href="javascript:void(0);"  onClick={this.handleView(AssetData.ASSET_ID)} class="view"> Promote </a>
                                            ...
                                            <div className="cardInforHomePage">
                                                ...
                                                <div className="tooltipCustom">
                                                    ...
                                                    <div style={{ width: "100%" }}>
                                                        <span style={{ color: '#F2A006', fontWeight: 600 }}>Sales Play : </span>
