...
export class FiltersList extends Component {
  ...
  render() {
    var mappingOnChange = this.props.onChange;
    ...
    function filterBox(event) {
        ...
        // alert(TrimmedVar);
        global.selectedMapcheckbox= TrimmedVar;
        
        mappingOnChange(global.selectedMapcheckbox);
    }
    // console.log(global.FilterDataMapList);
    if(global.FilterDataMapList!=undefined){
        var  FilterDataListnew=global.FilterDataMapList;  
        }else{
